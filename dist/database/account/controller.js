...
const GetOne = (email) => __awaiter(void 0, void 0, void 0, function* () {
    const account = yield model_1.AccountModel.findOne({ email: email }).exec();
    return account;
});
exports.GetOne = GetOne;
const UpdateOne = (email, dataUpdate) => __awaiter(void 0, void 0, void 0, function* () {
    yield model_1.AccountModel.updateOne({ email: email }, dataUpdate);
});
