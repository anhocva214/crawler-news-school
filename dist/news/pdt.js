...
const PDT = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let posts = root.querySelectorAll('.category-module')[0].querySelectorAll('li');
    posts.forEach((post) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (news.time == time_now) {
            ...
            if (!news_exist) {
                ...
                yield functions_1.SendNewsToMail(news.subject, news.title, news.url, "pdt");
                // console.log(news)
            }
        }
    }));
